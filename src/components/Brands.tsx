    ...
    <section className="py-10 md:py-16 bg-premium-bg border-t border-black/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between items-center mb-12">
          ...
          <a href="#products" className="text-sm font-bold text-premium-gray hover:text-premium-black transition-colors">View All Brands &rarr;</a>
        </div>
        
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 md:gap-8 items-center justify-items-center mt-8">
          {brands.map((brand) => (
            <div key={brand.name} className="w-full py-6 flex items-center justify-center px-4 grayscale hover:grayscale-0 hover:scale-110 transition-all duration-300 cursor-pointer">
