...
function CartDrawer() {
  const { cartItems, isCartOpen, setIsCartOpen, totalCartPrice, updateQuantity, removeFromCart } = useCart();
...
function AppContent() {
  return (
    <div className="min-h-screen bg-premium-bg font-sans text-premium-black relative overflow-x-clip">
      <Navbar />
      <Routes>
